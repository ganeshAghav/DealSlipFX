...
namespace FP.DAL.SQL
{
    ...
    public class DBUtility
    {
        ...
        FP.Common.Common oCommon = new FP.Common.Common();
        /// <summary>
        ...
        private SqlConnection GetConnection()
        {
            try
            {
                ...
                //string sConnectString = oFPCommon.CommonSettings.ConnectionString;

                ConnectionStringSettings conSettings = ConfigurationManager.ConnectionStrings["DBConnectionString"];
                string sConnectString = conSettings.ConnectionString;
